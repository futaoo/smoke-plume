...
def train_model(model, train_dl, val_dl, epochs, opt, loss):
    ...
    #     datadir = '/content/drive/MyDrive/Colab Notebooks/smoke-plume-detection/data',
    #     # seglabeldir='/path/to/segmentation/labels/for/training/', 
    #     seglabeldir = '/content/drive/MyDrive/Colab Notebooks/smoke-plume-detection/segmentation_labels',
    #     mult=1)
    # data_val = create_dataset(
    #     # datadir='/path/to/image/data/',
    #     datadir = '/content/drive/MyDrive/Colab Notebooks/smoke-plume-detection/data',
    #     # seglabeldir='/path/to/segmentation/labels/for/validation/', 
    #     seglabeldir = '/content/drive/MyDrive/Colab Notebooks/smoke-plume-detection/segmentation_labels',
    #     mult=1)
